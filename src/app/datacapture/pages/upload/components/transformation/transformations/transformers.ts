...
import { DeleteRow, Replace, Merge, Filter, FilterAndReplace, DefaultValue, Splitter, Calculator, FormatDate, GroupBy, TransformNumeric } from './transformers/transformer.model';
...
import { NumericTransformationComponent } from './transformation-interface/format/numeric-transformation/numeric-transformation.component';
...
export const TRANSFORMATIONS = [
  ...
  new TransformNumeric().setComponent(NumericTransformationComponent)
];
